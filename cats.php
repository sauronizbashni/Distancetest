...
?>
                <tr>
                  ...
                  <td colspan="2"><?php echo $cat["name"] ?></td>
                  <td colspan="2"><?php echo $cat["parent"] ?></td>
                  <td><form action="" method="post"><button type="submit" value="<?php echo $cat["id"] ?>" name="delcat" class="btn btn-primary">Удалить</button></form></td>
                </tr>
<?php
}
?>
              ...
              <tfoot>
                  ...
                  <th></th>
                  <th colspan="2"><input type="text" class="form-control" name="name" placeholder="название"></th>
                  <th colspan="2">
...
?>
                  ...
                  <th><button type="submit" value="add" name="addcat" class="btn btn-primary">Add</button></th>
                </form>
              </tfoot>
            </table>
          </div>
